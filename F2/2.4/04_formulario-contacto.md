...
| A-FORM-02 | Campos requeridos | 3.3.2 / 1.3.1 | A | **PENDIENTE VALIDAR** — Los campos requeridos deben indicarlo con `aria-required="true"` o `required`, no solo con asterisco visual. En DevTools verificar si los inputs tienen estos atributos | 🟠 Importante |
...
| A-FORM-06 | Navegación por teclado | 2.1.1 / 2.1.2 | A | **PENDIENTE VALIDAR** — Navegar el formulario con Tab. Verificar orden lógico y que el foco no quede atrapado en selects o componentes React | 🔴 Crítico |
